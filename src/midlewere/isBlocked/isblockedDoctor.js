...
var doctorModel_1 = __importDefault(require("../../models/doctorModel")); // Import User model and its TypeScript interface if defined
var checkIfBlocked = function (httpRequest, // Extend Request to include a possible userId property
res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                error_1 = _b.sent();
                console.error("Error checking blocked status:", error_1);
