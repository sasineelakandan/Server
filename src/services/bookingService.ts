...
import { ConfirmData, doctorData, DoctorDetials, DoctorSlots, IPayment, OutPutPatient, Patient, SelectedSlots, SuccessResponse } from "../Interface/Service/bookingService.type";
