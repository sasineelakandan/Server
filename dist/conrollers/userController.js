...
export class UserController {
    ...
    changeProfile = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    changePassword = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    getAppointments = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
            if (!userId) {
                console.error('User ID not found');
    ...
    cancelAppointments = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    updateProfilepic = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    chatwithDoctor = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    getChatMembers = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    getcompleteAppointment = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
            if (!userId) {
                console.error('User ID not found');
