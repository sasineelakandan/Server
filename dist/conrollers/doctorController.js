...
export class DoctorController {
    ...
    doctorSignup = async (httpRequest) => {
        try {
    ...
    doctorProfile = async (httpRequest) => {
        try {
    ...
    verifyProfile = async (httpRequest) => {
        try {
            const userId = httpRequest?.user?.id;
    ...
    resheduleAppointment = async (httpRequest) => {
        try {
            const doctorId = httpRequest?.user?.id;
    ...
    completeAppointment = async (httpRequest) => {
        try {
            const doctorId = httpRequest?.user?.id;
    ...
    cancelAppointment = async (httpRequest) => {
        try {
            const doctorId = httpRequest?.user?.id;
            const { appointmentId } = httpRequest?.body;
    ...
    chatwithUser = async (httpRequest) => {
        try {
            const doctorId = httpRequest?.user?.id;
    ...
    forgotPasswordOtp = async (httpRequest) => {
        try {
