export class AdminController {
    ...
    patientDetails = async (httpRequest) => {
        try {
    ...
    doctorDetails = async (httpRequest) => {
        try {
            const admin = httpRequest?.user?.id;
            if (!admin) {
                return {
    ...
    verifiedDoctors = async (httpRequest) => {
        try {
            const admin = httpRequest?.user?.id;
            if (!admin) {
                return {
    ...
    deleteDoctor = async (httpRequest) => {
        try {
    ...
    deleteReview = async (httpRequest) => {
        try {
