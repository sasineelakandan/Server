...
export class UserRepository {
    ...
    changeProfile = async (userId, name, phone) => {
        try {
    ...
    cancelAppointments = async (userId, appointmentId) => {
        try {
    ...
    chatwithDoctor = async (userId, appointmentId) => {
        try {
            if (!userId) {
                throw new Error(`User with ID ${userId} not found.`);
            }
    ...
    slotAsign = async (userId, slotData) => {
        try {
    ...
    getcompleteAppointment = async (userId) => {
        try {
            if (!userId) {
                throw new Error(`User with ID ${userId} not found.`);
            }
    ...
    userReview = async (userId, Review) => {
        try {
            if (!userId) {
                throw new Error(`User with ID ${userId} not found.`);
            }
