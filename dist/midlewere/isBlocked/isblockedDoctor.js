...
const doctorModel_1 = __importDefault(require("../../models/doctorModel")); // Import User model and its TypeScript interface if defined
...
res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = yield doctorModel_1.default.findOne({ _id: userId }); // Retrieve user from the database
        console.log(user);
        if (!user) {
